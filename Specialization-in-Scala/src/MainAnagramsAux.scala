...
object MainAnagramsAux {
  ...
  def subtract(x: Occurrences, y: Occurrences): Occurrences = {
    def loop(oc: Occurrences, ch: Char): Occurrences = {
      val occs = 
        for( (c, o) <- oc ) yield 
          if( c == ch ) (c, o - 1)
          else (c, o)
      occs.filter((ci) => ci._2 > 0)
    }        
    if( y.length == 0 ) x
    else {
      val ch = y.head._1
      subtract(loop(x, ch), loop(y, ch))
    }
  }
  ...
  def sentenceAnagrams(sentence: Sentence): List[Sentence] = {    
	...
	def main(args: Array[String]) {
	  ...
	  //val example = List(('a',1),('e',1),('m',1),('n',1),('s',1),('y',1))
    ...
    //val example = List(('a',1),('m',1),('n',1))
	  //val example = List(('e',1),('s',1),('y',1))
	  //val example = List(('a',1),('e',1),('m',1),('n',1),('s',1),('y',1))
	  //val example = List(('e',1), ('i',1), ('l',2), ('n',1), ('r',1), ('u',2), ('x',1), ('z',1))
